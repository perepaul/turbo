                ...
                <form action="{{ route('user.deposit.create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" name="fee" value="5.00" disabled readonly style="cursor: not-allowed">
                        </div>
                        <div class="form-group col-6">
                            <label for=""><strong>Total</strong></label>
                            <input type="text" class="form-control" name="total" readonly disabled style="cursor: not-allowed">
                        </div>
                    </div>
