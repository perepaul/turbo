        ...
        <div class="card-body">
            <form action="{{route('user.representative')}}" method="POST" class="row p-4" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="firstname" type="text" class="form-control" name="firstname" value="{{$rep?->firstname}}">
                    <x-error key="firstname" />
                </div>
                <div class="form-group col-md-6">
                    <label for="lastname">Last name</label>
                    <input id="lastname" type="text" class="form-control" name="lastname" value="{{$rep?->lastname}}">
                    <x-error key="lastname" />
                </div>
                <div class="form-group col-md-6">
                    <label for="">Country</label>
                    <select name="country" id="country" class="form-select">
                        <x-countries country="{{$rep?->country}}" />
                    </select>
                    <x-error key="country" />
                </div>
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <select name="state" id="state" class="form-select">
                        <x-states selected="{{$rep?->state}}" country="{{$rep?->country}}" />
                    </select>
                    <x-error key="state" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="address" type="text" class="form-control" name="address" value="{{$rep?->address}}">
                    <x-error key="address" />
                </div>

                <div class="form-group col-md-8">
                    <label for="city">City</label>
                    <input id="city" type="text" class="form-control" name="city" value="{{$rep?->city}}">
                    <x-error key="city" />
                </div>
                <div class="form-group col-md-4 mb-3">
                    <label for="zip_code">Zip/Postal Code</label>
                    <input id="zip_code" type="text" class="form-control" name="zip_code" value="{{$rep?->zip_code}}">
                    <x-error key="zip_code" />
                </div>
                <div class="col-12 mb-3">
                    <p>Would you love to share our platform on your social media account?</p>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="question_one" id="question_one_yes" value="yes" @if($rep?->question_one == 'yes') checked="checked" @endif>
                        <label class="form-check-label" for="question_one_yes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="question_one" id="question_one_no" value="no" @if($rep?->question_one == 'no') checked="checked" @endif>
                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="question_two" id="question_two_yes" value="yes" @if($rep?->question_two == 'yes') checked="checked" @endif>
                        <label class="form-check-label" for="question_two_yes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="question_two" id="question_two_no" value="no" @if($rep?->question_two == 'no') checked="checked" @endif>
                ...
                <div class="form-group">
                    ...
                    <textarea style="min-height: 100px;" name="question_three" id="question_three" class="form-control" placeholder="To what extent do you intent to promote the platform?">{{$rep?->question_three}}</textarea>
