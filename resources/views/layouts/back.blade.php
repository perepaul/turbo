...
<head>
    ...
    <link rel="stylesheet" href="/assets/back/vendor/dotted-map/css/contrib/jquery.smallipop-0.3.0.min.css"
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/" class="brand-logo">
                <img src="{{ favicon() }}" alt="" style="width:55px; height:auto">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <img src="{{ profile_picture() }}" style="width: 30px; height:30px"
                                        alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ request()->isAdmin() ? route('admin.settings.profile.index') : route('user.profile') }}"
            ...
            <div class="container-fluid">
                ...
                @if ((request()->isUser() && auth()->user()->trade_cert == 'require') || auth()->user()->trade_cert == 'uploaded')
                    <div class="alert alert-outline-warning fade show" role="alert">
                        <strong><i class="fa fa-exclamation-circle"></i></strong> Your account is currently
                        <strong>inactive</strong> as we have requested for your trading licence, your account will be
                        activated when it is verified. <a href="{{ route('user.kyc.index') }}">click to continue</a>
                    </div>
                @endif
