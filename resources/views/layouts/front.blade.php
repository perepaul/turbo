        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="dreamNav">
                    ...
                    <a class="nav-brand" href="#"><img draggable="false" src="{{ logo() }}" alt="logo"
                        ...
                        <div class="footer-copywrite-info">
                            ...
                            <div class="copywrite_text wow fadeInUp" data-wow-delay="0.2s">
                                <div class="footer-logo">
                                    <a href="{{ route('front.index') }}"><img draggable="false"
                                            src="{{ logo() }}" alt="logo" style="width:180px"></a>
                                </div>
                                <p>Get access to the world most sought out stocks and cryptos, generate trading
                                    strategies with the help of our sophisticated but simple market data analysis
                                    section</p>
                            </div>
                        </div>
                    </div>
