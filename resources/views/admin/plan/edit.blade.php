...
<div class="row">
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.plan.update', $plan->id) }}" method="post" class="row p-lg-3">
                    @method('PUT')
                    @csrf
                    <div class="col-md-7">
                        <h3>Plan Data</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="amount" name="amount" class="form-control" value="{{ $plan->amount }}">
                            <x-error :key="'amount'" />
                        </div>
                        <div class="form-group">
                            <label for="bonus">Topup Bonus</label>
                            <input type="text" id="bonus" name="bonus" class="form-control" value="{{ $plan->bonus }}">
                            <x-error :key="'bonus'" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-12 text-center">
                        <button type="submit" class="btn btn-info mt-3">Update Plan</button>
                    </div>
                </form>
            </div>
        </div>
