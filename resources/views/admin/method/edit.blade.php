    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.settings.methods.update',$method->id) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        value="{{ $method->name }}" placeholder="Bitcoin">
                                    <x-error :key="'name'" />
                                </div>
                                <div class="form-group">
                                    <label for="address">Address</label>
                                    <input type="text" id="address" name="address" class="form-control"
                                        value="{{ $method->address }}" placeholder="xxxxxxxxxxxxxxxxxxx">
                                    <x-error :key="'address'" />
                                </div>
                                    ...
                                    <label for="image" class="mt-3">
                                        ...
                                        <div class="preview">
                                            @if (!is_null($method->image))
                                                <img src="{{ asset(config('dir.methods') . $method->image) }}"
