                ...
                <div class="col-md-8 col-sm-12 ms-0 ms-sm-4 ms-sm-0">
                    <div class="compose-content">
                        <form action="{{ route('admin.emails.send') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control bg-transparent" placeholder=" Subject:" name="subject" value="{{old('subject')}}">
                                <x-error :key="'subject'" />
                            </div>
                            <div class="mb-3">
                                <textarea id="email-compose-editor" class=" form-control" rows="15" name="message" placeholder="Enter text ...">{{trim(old('message'))}}</textarea>
                                <x-error :key="'message'" />
                            </div>
                            ...
                            <div class="text-start mt-4 mb-3">
                                ...
                                <button class="btn btn-danger light btn-sl-sm" type="reset"><span class="me-2"><i class="fa fa-times"></i></span>Discard</button>
                            </div>
                        </form>
                    </div>
                </div>
