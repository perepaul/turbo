            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 flex-align order-r-1 mb-r-30 wow fadeInRight">
                    <div class="work-box">
                        ...
                        <p class="work-des pb-20">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 flex-align mb-r-30 wow fadeInLeft">
                    <div class="work-box">
                        ...
                        <p class="about-des pb-20">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                            praesentium </p>
